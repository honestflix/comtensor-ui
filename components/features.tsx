...
import FeatIllustration from '@/public/images/features.png'
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">Modular + Subnets Architecture</div>
                  <h3 className="h3 mb-3">What we can do with comtensor</h3>
                  <p className="text-xl text-gray-400 mb-4">Networking and Wrapping almost thing of bittensor.</p>
                  ...
                  <div className="flex items-start mt-8">
                    ...
                    <div>
                      <blockquote className="text-gray-400 italic m-0 mb-3">"Amazing, all AI features are in here - Comtensor".</blockquote>
