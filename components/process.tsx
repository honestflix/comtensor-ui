      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">Decentralized Incentivized Internet</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Bittensor is revolutionizing the development of machine learning platforms by decentralizing the process and creating a peer-to-peer market for machine intelligence.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Comtensor</h4>
              <p className="text-lg text-gray-400 text-center">Comtensor makes users can meet all the features of bittensor.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Cross-Validator</h4>
              <p className="text-lg text-gray-400 text-center">Cross validator enables commune validators can query to bittensor miners directly.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Subnets</h4>
              <p className="text-lg text-gray-400 text-center">We have 32 subnets on bittensor so we will have 32 modules in comtensor, too..</p>
            </div>
